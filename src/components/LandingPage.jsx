...
const partners = [
  ...
  { name: 'Codium AI', color: '#00D4AA' },
  { name: 'Make', color: '#6D4AFF' },
  { name: 'TechStart', color: '#10b981' },
  { name: 'DigiCraft', color: '#ec4899' },
];
        ...
        <div className="relative">
          <div className="flex gap-12 animate-scroll">
            {[...partners, ...partners].map((partner, i) => (
              <div 
                key={i} 
                className="flex-shrink-0 flex items-center gap-2 px-6 py-3 bg-white/5 rounded-lg border border-white/5 hover:border-white/20 transition-colors"
              >
                <div 
                ...
                <span className="text-sm text-gray-400 whitespace-nowrap">{partner.name}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              { ref: stat2.ref, value: stat2.count, suffix: '+', label: 'zufriedene Kunden', icon: Users },
        ...
        >
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
              ...
              <button 
                type="submit" 
                className="w-full bg-gradient-to-r from-cyan-500 to-violet-500 hover:from-cyan-400 hover:to-violet-400 py-4 rounded-xl font-semibold transition-all duration-300 hover:shadow-lg hover:shadow-violet-500/25"
              >
                Gespräch anfragen
              </button>
